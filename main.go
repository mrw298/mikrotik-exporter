...
var (
	...
	withQueueTrees = flag.Bool("with-queue-trees", false, "retrieves queue tree metrics")
...
func collectorOptions() []collector.Option {
	...
	if *withQueueTrees || cfg.Features.QueueTrees {
		opts = append(opts, collector.WithQueueTrees())
	}
